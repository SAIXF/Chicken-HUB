...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Chicken HUB Notification", 
        Text = tostring(value),
...
local win = library:Window("CHICKEN",[[ HUB]],[[Version : FREE ]],"9606070311",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("Main",[[7040391851]])
